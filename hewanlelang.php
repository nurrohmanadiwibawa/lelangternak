      ...
      <section id="courses" class="courses">
        <div class="container" data-aos="fade-up">
          <div class="row" data-aos="zoom-in" data-aos-delay="100">
            <?php while ($Lelang[] = mysqli_fetch_array($resultLelang)) {
              if (isset($_POST["tawar$x"])) {
                $_SESSION['id_produk'] = $Lelang[$x]['id_produk'];
              ...
              <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="course-item">
                  <img style="width: 350px; height: 210px;" src="assets/img/<?php echo $Lelang[$x]['gambar_produk'] ?>" class="img-fluid" alt="..." />
                  <div class="course-content">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <p class="price" style="font-size: 13px;">Last Bid: Rp <?php echo number_format($Lelang[$x]['hrgawal_produk'], 0, ',', '.') ?></p>
                      <p class="price" style="font-size: 13px;">Harga jual: Rp <?php echo number_format($Lelang[$x]['hrgjual_produk'], 0, ',', '.') ?></p>
                    </div>

                    <h3><?php echo $Lelang[$x]['nm_produk'] ?></h3>
                    <p><?php echo $Lelang[$x]['deskripsi_produk'] ?></p>
                    <div class="trainer d-flex justify-content-between align-items-center">
                      <div class="trainer-profile d-flex align-items-center">
                        <img style="width: 25px; height:25px;" src="assets/img/trainers/location.png" class="img-fluid" alt="" />
                        <span><?php echo $Lelang[$x]['lokasi'] ?></span>
                      </div>
                      <div>
                        <h4 id="countdown-<?php echo $x ?>"><?php echo $Lelang[$x]['formatted_deadline'] ?></h4>
                        <script>
                  ...
                  <div class="trainer d-flex justify-content-center align-items-center">
                    <form method="post"><button type="submit" class="btn btn-dark" name="tawar<?php echo $x ?>">Detail</button></form>
                  </div>
                </div>
              </div>
            <?php $x++;
